...
export default function LearnCard({ deck }: { deck: Deck }) {
  return (
    <Link
      ...
      className="group block p-5 rounded-gentle bg-canvas border border-canvas-mist 
    ...
    >
      ...
      <div className="mt-4 flex items-center text-signal text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200">
        <span>View deck</span>
